...
import com.example.computers.entities.Roles;
...
public class UserService implements UserDetailsService {
    ...
    public boolean addNewUser(Users user) {
        ...
        if (!StringUtils.isEmpty(user.getEmail())) {
            ...
            String message = String.format("Hallo, %s.\nFor activation your account on computers visit next link: %s/activate/%s", user.getUsername(), myhostname, user.getActivationCode());
